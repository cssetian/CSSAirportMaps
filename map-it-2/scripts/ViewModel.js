...
MapIt.ViewModel = function() {
  ...
  self.mapMarkerArray = ko.observableArray([
  ...
  self.mapMarkerArray.subscribe(function(){
    if(self.anyAirportSelected()) {
      ...
      self.mapMarkerArray()[0].marker.setMap(null);
    } else {
      console.log('INTIIAL MAP MARKER GETTIN\' PUT BACK IN');
      self.mapMarkerArray()[0].marker.setMap(self.map());
      self.map().panTo(self.mapMarkerArray()[0].marker.position);
    }
  });
  ...
  self.departureAirportUpdateHandler = function (newAirportMarker) {
    ...
    if(typeof newAirportMarker === 'undefined' || newAirportMarker === null || typeof newAirportMarker.title === 'undefined') {
      self.mapMarkerArray()[1].marker.setMap(null);
      ...
      self.mapMarkerArray()[1].marker.setMap(self.map());
      self.mapMarkerArray()[1].marker.setPosition(newAirportMarker.position);
  ...
  self.arrivalAirportUpdateHandler = function (newAirportMarker) {
    ...
    if(typeof newAirportMarker === 'undefined' || newAirportMarker === null || typeof newAirportMarker.title === 'undefined') {
      self.mapMarkerArray()[2].marker.setMap(null);
      ...
      self.mapMarkerArray()[2].marker.setMap(self.map());
      self.mapMarkerArray()[2].marker.setPosition(newAirportMarker.position);
      self.map().panTo(newAirportMarker.position);
    }
  };
  ...
  self.twoAirportsSelected.subscribe(function(newVal){
    if(newVal === true) {
      ...
      if(self.departureAirportSelected()) {
        ...
        self.map().setZoom(10);
        self.map().panTo(self.mapMarkerArray()[1].marker.position);
        ...
        self.map().setZoom(10);
        self.map().panTo(self.mapMarkerArray()[2].marker.position);
